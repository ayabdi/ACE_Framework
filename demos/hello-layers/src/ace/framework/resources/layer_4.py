...
class Layer4(Layer):
    ...
    def process_layer_messages(self, control_messages, data_messages, request_messages, response_messages, telemetry_messages):
        ...
        llm_op_response: GptMessage = self.llm._create_conversation_completion('gpt-4', llm_op_messages)
        ...
        south_op_prompt, north_op_prompt = self.get_op_description(llm_op_response_content, "l4_south.md", "l4_north.md")
        ...
        llm_response: GptMessage = self.llm._create_conversation_completion('gpt-4', llm_messages)
